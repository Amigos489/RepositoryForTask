...
import importcsv.BookImportCSV;
import importcsv.BookRequestImportCSV;
import importcsv.OrderImportCSV;
import json.JsonStorage;
import sorted.SortedBookByAvailability;
import sorted.SortedBookByName;
import sorted.SortedBookByPrice;
import sorted.SortedBookByDateOfPublication;
import sorted.SortedBookRequestByBookID;
import sorted.SortedOrderByPrice;
import sorted.SortedBookRequestByCount;
import sorted.SortedOrderByOrderStatus;
import sorted.SortedOrderByDateOfExecution;
...
public class ServiceStoreBook {
    ...
    public ArrayList<BookRequest> sortedCriterionBookRequest(int choice) {
        ...
        switch (choice) {
            case 1:
                Collections.sort(requests, new SortedBookRequestByBookID());
                break;
            case 2:
        ...
        try {
            switch (choice) {
                ...
                case 2:
                    ...
                    return StatusImportExport.CORRECTLY;
                case 3:
                    BookRequestImportCSV bookRequestImport = new BookRequestImportCSV();
                    ArrayList<BookRequest> importedBookRequests = bookRequestImport.importFromFile("BookRequests.csv");
